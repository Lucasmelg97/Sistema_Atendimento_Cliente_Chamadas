                    ...
                    <div class="tab-content">
                        ...
                        <div class="modal" id="modalConfirmacao" tabindex="-1" role="dialog"
                            ...
                            function editaRegional(){
                                ...
                                $obj_regionais = new Classe_Regional_DAO();
                                $obj_regionais->idRegional = $_SESSION['idEdit'];
                                $obj_regionais->regional = $_POST['regional'];
                            ...
                            <form class="modal-content-personalizado" action="" method="post" id="deletar-cidade">
                                <div class="container">
                                    ...
                                    <div class="clearfix">
                                        ...
                                        <button type="submit"
                                            onclick="document.getElementById('id01').style.display='none'"
                                            class="deletebtn" id="delete" name="delete">Deletar</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-5">
                                    <div class="main-card mb-3 card">
                                        <div class="card-body">
                                            <h5 class="card-title">Informações do Novo Plano</h5>


                                        </div>
                                        <div class="col-lg-5">
                                            <div class="position-relative form-group"><label for="exampleSelect"
                                                    class="">Cliente Atendeu?</label><select name="select"
                                        ...
                                        <div class="col-lg-5">
                                            <div class="position-relative form-group"><label for="exampleSelect"
                                                    class="">Foram reforçadas as informações do produto?</label><select
                                        ...
                                        <div class="col-lg-5">
                                            <div class="position-relative form-group"><label for="exampleSelect"
                                                    class="">Motivo que o levou a fazer o plano?</label><select
                                                    name="select" id="exampleSelect" class="form-control">
                                                    <option> - </option>
                                                    <option>Necessidade Ligação</option>
                                                    <option>Compra de Aparelho (Fidelização)</option>
                                                    <option>Troca de Chip</option>
                                                    <option>Atualização automática</option>
                                                    <option>Sinal da VIVO</option>
                                                    <option>Aplicativo disponíveis</option>
                                        ...
                                        <div class="col-lg-5">
                                            <div class="position-relative form-group"><label for="exampleSelect"
                                                    class="">Cliente ciente da data de vencimento?</label><select
                                                    name="select" id="exampleSelect" class="form-control">
                                                    <option> - </option>
                                                    <option>Sim</option>
                                                    <option>Não</option>
                                        ...
                                        <div class="col-lg-5">
                                            <div class="position-relative form-group"><label for="exampleSelect"
                                                    class="">Cliente possui débito automático?</label><select
                                                    name="select" id="exampleSelect" class="form-control">
                                                    <option> - </option>
                                                    <option>Sim</option>
                                                    <option>Não</option>
                                        ...
                                        <div class="col-lg-5">
                                            <div class="position-relative form-group"><label for="exampleSelect"
                                                    class="">Foi ofertado débito automático em loja?</label><select
                                                    name="select" id="exampleSelect" class="form-control">
                                                    <option> - </option>
                                                    <option>Sim</option>
                                                    <option>Não</option>
                                        ...
                                        <div class="col-lg-5">
                                            <div class="position-relative form-group"><label for="exampleSelect"
                                                    class="">Houve não conformidade?</label><select name="select"
                                                    id="exampleSelect" class="form-control">
                                                    <option> - </option>
                                                    <option>Sim</option>
                                                    <option>Não</option>
                                        ...
                                        <div class="position-relative form-group">
                                            <div class="col-md-10">
                                                <div class="position-relative form-group"><label for="exampleText"
                                                        class="">Observação:</label><textarea name="text"
                                                        id="exampleText" class="form-control"></textarea></div>
                                            </div>
                                        ...
                                        <div class="col-lg-5">
                                            <div class="position-relative form-group"><label <?php
                                                            if (isset($_SESSION['idEdit'])) {
                                                                ...
                                                                echo'<button class="mt-2 btn btn-primary" type="submit">Enviar</button>';   
                                                            }
                                                        ?> </form>
                                ...
                                <div class="col-lg-7">
                                    <div class="main-card mb-3 card">
                                        <div class="card-body">
                                            <h5 class="card-title">Busca - Clientes</h5>
                                            <?php
                                                    include 'tabelas.php';
                                                    ?>
                                            <!--TABELA DESPESAS-->
                                            ...
                                            <table class="OpenDataTable">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th data-colsearch="yes">Acesso</th>
                                                        <th data-colsearch="yes">Portabilidade</th>
