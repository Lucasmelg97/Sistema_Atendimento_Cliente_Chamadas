...
<head>
    ...
    <title>Consulta de Vendas para Atendimento</title>
    <meta name="viewport"
    ...
    <div class="app-container app-theme-white body-tabs-shadow fixed-sidebar fixed-header">
        ...
        <div class="app-main">
            <div class="app-sidebar sidebar-shadow">
                ...
                <div class="scrollbar-sidebar"><?php require 'menu-lateral.php'?></div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="main-card mb-3 card">
                                <div class="card-body">
                                    <h5 class="card-title">Busca - Venda de Serviços</h5>
                                    <?php
                                                    include 'tabelas.php';
                                                    ?>
                                    <!--TABELA DESPESAS-->
                                ...
                                <div class="d-inline-block dropdown">
                                        ...
                                        <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right">
                                                            <ul class="nav flex-column">
                                                                <li class="nav-item">
                                                                    <a href="exportar-vendaservicos.php" class="nav-link">
