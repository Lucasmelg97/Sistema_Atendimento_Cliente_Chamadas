...
include 'classe-opcoesresposta.php';
include_once "config.php";


class Classe_Opcoes_Resposta_DAO{
 ...
 * D = delete 		->		Deleta linhas da tabela
 -----------------------------------------------------------------------------*/
 		...
 		public function inserir($Opcoesresposta){

 			/* Primeiro cria a query do MySQL */
 			$insert_query =	"INSERT INTO  opcoesresposta(iDresposta, OpcaoResposta) VALUES(default,'".$Opcoesresposta->OpcaoResposta."')";
 		...
 		public function buscaTodasChamadas(){
 			...
 			/* Primeiro cria a query do MySQL */
 			$id_query = "SELECT * FROM opcoesresposta";
